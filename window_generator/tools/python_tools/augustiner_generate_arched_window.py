...
create_and_save_arched_window(
        ...
        windowsill = 'n',
        window_type = '1',
        save_path_name = '/Users/thorstengerdsmeier/Documents/Modellbahn/python_scripts/generated_windows/Augustiner')
